...
activities = {
    ...
    "Swimming Team": {
        "description": "Swim training and meets for all skill levels",
    ...
    "Drama Club": {
        "description": "Acting, stagecraft, and putting on school performances",
